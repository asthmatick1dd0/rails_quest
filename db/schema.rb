...
ActiveRecord::Schema[8.1].define(version: 2026_05_05_060000) do
  ...
  create_table "agents", force: :cascade do |t|
    ...
    t.check_constraint "level BETWEEN 1 AND 10", name: "agents_level_between_1_and_10"
  end
  ...
  create_table "missions", force: :cascade do |t|
    ...
    t.check_constraint "status IN ('assigned', 'in_progress', 'completed')", name: "missions_status_valid"
  end
